...
def prediction_iris(predicted_x, prior_probability, conditional_probability):
    p0 = prior_probability[0] \
         * gauss(predicted_x[0], conditional_probability[0][0][0], conditional_probability[0][0][1]) \
         * gauss(predicted_x[1], conditional_probability[1][0][0], conditional_probability[1][0][1]) \
         * gauss(predicted_x[2], conditional_probability[2][0][0], conditional_probability[2][0][1]) \
         * gauss(predicted_x[3], conditional_probability[3][0][0], conditional_probability[3][0][1])

    p1 = prior_probability[1] \
         * gauss(predicted_x[0], conditional_probability[0][1][0], conditional_probability[0][1][1]) \
         * gauss(predicted_x[1], conditional_probability[1][1][0], conditional_probability[1][1][1]) \
         * gauss(predicted_x[2], conditional_probability[2][1][0], conditional_probability[2][1][1]) \
         * gauss(predicted_x[3], conditional_probability[3][1][0], conditional_probability[3][1][1])

    p2 = prior_probability[2] \
         * gauss(predicted_x[0], conditional_probability[0][2][0], conditional_probability[0][2][1]) \
         * gauss(predicted_x[1], conditional_probability[1][2][0], conditional_probability[1][2][1]) \
         * gauss(predicted_x[2], conditional_probability[2][2][0], conditional_probability[2][2][1]) \
         * gauss(predicted_x[3], conditional_probability[3][2][0], conditional_probability[3][2][1])
